    ...
    <div className="max-w-md w-full bg-card shadow-lg rounded-lg p-6 border border-border">
      ...
      <div className="flex space-x-3">
        ...
        <button
          ...
          className="flex-1 bg-muted text-muted-foreground py-2 px-4 rounded-md hover:bg-muted/80 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
        >
          刷新页面
        </button>
      </div>
